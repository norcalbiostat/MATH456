...
This is the landing page for <span style="color:blue">**Applied Statistics II**</span> course taught by [Dr. Robin Donatello](http://www.norcalbiostat.com) for <span style="color:blue">**Spring 2022**</span>.  This page is used for posting of regular announcements and information for students of the class. 

```{r, echo=FALSE, message=FALSE, warning=FALSE}
wk1.date <- as.Date("2022-01-23")
```
...
* We will use Discord for all outside of class communication. 
    ...
    - Instructions to join can be found in [Hw0](hw/hw00-getting-started.html)
* Software Updates: 
    - Update your version of `R studio` for sure. Update R if you're running < 4.2. 
* If you've had me in a class before, you know that there *will* be typos and broken links on this webpage. Here is how you can contribute to the fix.
    - good: Notify me in Discord. That way I can confirm in public when the issue is resolved. 
    - better: open up an Issue in [Github](https://github.com/norcalbiostat/MATH456)
