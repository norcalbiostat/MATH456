...
1) Each team will present their analysis as a 10-15 minute presentation with slides. 
    - Presentation time will be scheduled during finals week. 
    - Some presentations will occur during our regularly scheduled final time (Fri 12-2).
    - All group members must be present and take part in the presentation. 
2) When you are not presenting, you are expected to pay attention and ask relevant questions. If you don't get a chance to ask during the presentation, you will have to directly comment on their slides for credit. 
