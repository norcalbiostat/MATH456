...
* [Right click this link to download the R Markdown template for this homework.](hw01-modeling-template.Rmd) 
...
* Knit/render to PDF and submit to Google Drive: `Topic 01: Statistical Modeling/Draft` folder by the due date. 

* This is a peer reviewed assignment. After the PR period, you should update your assignment with corrections by your peers, and submit a final version into the `Topic 01: Statistical Modeling/Final` Google folder. 

## Get Data
* The code to get the data used for this assignment is included in the template. 
* Download codebooks here:  [Lung Function](https://www.norcalbiostat.com/data/DepressCodebook.txt), [Parental HIV](https://www.norcalbiostat.com/data/ParhivCodebook.txt), [Depression](https://www.norcalbiostat.com/data/DepressCodebook.txt)
