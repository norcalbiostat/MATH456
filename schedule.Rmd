...
All due dates and submission instructions are posted in Canvas. 
...
weekdates[8] <- "Spring Break (03/13)"
weekdates[17] <- "Finals Week (05/15)"
...
```{r}
# Read in schedule
raw_slo_detail <- read_excel("schedule_456.xlsx", sheet="slo_detail")
