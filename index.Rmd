...
<center><span style="color:#cc3300;font-size:24pt;text-align:center">In person classes are cancelled March 13-24.</span></center>
<center><span style="color:#cc3300;font-size:24pt;text-align:center">Online classes are not affected.</span></center>
...
### `r format(wk1.date+6*10, "%m-%d-%Y")`: Getting back to business, Long but important notice about class changes. 

Changes to our class structure and expectations got long, so I moved it to another document. You can read it [here](notes/class_structure_changes.html). 
...
* Project presentation that we were going to do the Friday before finals, will now be due this Friday. 
* See the [project page](project.html#project_update_I) for more details as there has been changes to the delivery requirements. 
  


### `r format(wk1.date+6*8, "%m-%d-%Y")`: Midterm, Project updates. 
