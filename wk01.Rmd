...
* If your Slack account uses your @csuchico.edu email, you should be able to search for the workspace and add yourself. If you have a different email address then use the following 
[[Slack Invitation Link]](https://join.slack.com/t/math456/shared_invite/enQtMzAwMzEyNDA2NTUxLWQyZTc1NDM2NzZiMGQ5MjVhODRhZjIyM2QxMGZlMDJhNjY0ZTRhODhiMTg5YWU0ZDAzZThhYjcwMDBhOGRiNjY) to join. 
...
* Your goal is to collect around 25,000 XP from any course in Data Camp. This is approximately 5 clases. 
* You have all semsester to do so. I will assign midterm progress points around Spring Break. 
