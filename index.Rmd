...
This is the landing page for <span style="color:blue">**Applied Statistics II**</span> course taught by [Dr. Robin Donatello](http://www.norcalbiostat.com) for <span style="color:blue">**Spring 2023**</span>.  This page is used for posting of regular announcements and information for students of the class. 

```{r, echo=FALSE, message=FALSE, warning=FALSE}
wk1.date <- as.Date("2023-01-23")
```
...
### `r format(wk1.date+1*7, "%m-%d-%Y")`: Model building - how to choose variables


* This week we start topic 1: Model building. We will cover ways that variables can confound, or moderate existing planned relationships and learn how to interpret intearction terms.
* You'll get your first experience conducting a peer review (Due Tue) and with the Question Formulation Technique QFT) on Monday. . 
...
* Make sure you acquaint yourself with this website and our Canvas course page, it they will be your guide for the next 16 weeks. 
* To best ensure your success in this class, head over to Canvas now and review the first module, and the first setup homework! 
