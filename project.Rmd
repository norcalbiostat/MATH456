...
* Week 10: `r emo::ji("heavy_check_mark")`  Project update I (Written summary + Presentation), [Evaluation of progress towards effective team functioning](https://norcalbiostat.github.io/MATH456/notes/Effective-Teams.pdf)
...
### THURSDAY 2-4pm
* Concussion Effects on Mental Health in Adolescent Athletes: Madeline, Abbie, Tanya
* Housing Insecurity. Monitoring the housing crisis of students at Chico State: Kaleb, Laural, Constantine
* NBA Rest and Travel time vs Injuries: Gio, Karley, Collin
* NFL Play by Play: Brandon, Jenny, Kris, Tyler
* Salty Soils: Irfan, Olivia, Jessica S

### FRIDAY 12-2pm
* MLB Awards and Player Statistics: Connor, Kyle, Matthew
* College Scoreboard: Hunter, Mitch
* Exploring Public Views on Gene Editing: Jessica MA, Jacob, Devin
* The association between the meat industry and methane emissions: Nicole, Drew, Jake
* NBA Playstyles: Mason, Joe, Nidhi
...
2. A peer rating of each other team member. This is confidential, but will be factored into the individual grades. [[Link forthcoming]]()
