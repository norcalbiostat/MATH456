...
* `ozone.txt` contains hourly ozone levels for censor locations in Southern California measured on three different days. 
* `ozone_cities.csv` contains polygon data for cities near the censor locations. 
